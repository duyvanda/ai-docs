...
| **CRM (Quản lý trực tiếp)** | - Lập đề xuất M.Session (tương tự CRS).<br>- Xem và theo dõi các đề xuất M.Session của nhân viên cấp dưới.<br>- Xác nhận tham dự hoặc hủy sự kiện sau khi đề xuất được CXS duyệt.<br>- Nộp chứng từ sau sự kiện (hình ảnh, hóa đơn PDF). |
| **CXS (Chuyên viên sản phẩm)** | - Xem danh sách đề xuất được giao, lọc theo CRM/CXS/Mã NT.<br>- Điền danh mục vật tư cần mang theo.<br>- Điều chỉnh người đi nói bài và CXM hỗ trợ.<br>- Duyệt hoặc từ chối đề xuất.<br>- Ghi nhận thực tế vật tư đã dùng sau sự kiện. |
